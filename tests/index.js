...
test.push(new pvec.PVec());
test.set(new pvec.PVec());
test.pop(new pvec.PVec());

console.info('Transient vector tests:')
test.push(new pvec.TVec());
test.set(new pvec.TVec());
test.pop(new pvec.TVec());

console.info('Interop tests: ')
test.transience(new pvec.PVec());
